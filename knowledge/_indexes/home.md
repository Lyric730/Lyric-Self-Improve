...
这是 Obsidian 打开后的主入口。优先从这里进，不要靠文件树硬翻。
...
- [Project SOP Map](project-sop-map.md)
...
- [ ] `00-inbox/` 是否清空或标注下一步
- [ ] 新增项目是否写进 [project-map.md](project-map.md)
- [ ] 项目 SOP 是否写进 [project-sop-map.md](project-sop-map.md)
- [ ] 成熟项目产出是否沉淀进 `knowledge/`
- [ ] 外部事实是否有来源链接
- [ ] 临时计划是否已经归档或删除
